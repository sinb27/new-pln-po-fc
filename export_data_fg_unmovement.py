...
if len(df) > 0:
    ...
    table_name = "pln.pln_fg_unmovement"
    ...
    query6 = ('''
    delete from pln.pln_fg_unmovement pfu
    where pfu.update_datetime != (select max(pfu.update_datetime)  
